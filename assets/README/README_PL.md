...
- **Wielosilnikowa wiedza** — wersjonowane biblioteki RAG z LlamaIndex, PageIndex, GraphRAG, LightRAG, zdalnym LightRAG Server lub biblioteką Tencent IMA, lub podłączonym vault Obsidian, z podłączalnym parsowaniem dokumentów.
