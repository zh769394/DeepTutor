...
- **Connaissances multi-moteur** — bibliothèques RAG versionnées via LlamaIndex, PageIndex, GraphRAG, LightRAG, un LightRAG Server distant ou une bibliothèque Tencent IMA, ou un vault Obsidian lié, avec une analyse de documents enfichable.
