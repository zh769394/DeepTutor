...
- **Субагенты и Partners** — обращайтесь к живой агентной среде (Claude Code, Codex, Antigravity, Kimi, opencode, MiMo, Hermes, OpenClaw или DeepSeek) или к Partner из любого хода (либо импортируйте прошлые разговоры) и запускайте постоянных IM-компаньонов на том же мозге.
...
pip install -e ".[graphrag]"        # Движок Microsoft GraphRAG
...
На главной странице **Chat**, **Ask Questions**, **Quiz**, **Visualize** и **Immersive Watching** доступны в один клик; **Research** для цитируемых отчётов и **Solve** для пошаговых рассуждений находятся в разделе *Дополнительные возможности*. **Mastery Path** и **Immersive Reading** представлены отдельными рабочими пространствами на боковой панели, а Course Study сохраняет собственный контекст, привязанный к курсу.
