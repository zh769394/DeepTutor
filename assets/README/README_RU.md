...
- **Многодвигательные знания** — версионированные RAG-библиотеки на основе LlamaIndex, PageIndex, GraphRAG, LightRAG, удалённого LightRAG Server или библиотеки Tencent IMA, либо связанного хранилища Obsidian, с подключаемым разбором документов.
