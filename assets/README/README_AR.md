...
- **بيئة تشغيل واحدة لجميع الأوضاع** — Chat وQuiz وResearch وVisualize وSolve وMastery Path وImmersive Reading تعمل على نفس حلقة الوكيل، لذا تغيّر الهدف لا المحرك، والسياق يتبع المتعلم.
...
- **معرفة متعددة المحركات** — مكتبات RAG مُصدَّرة عبر LlamaIndex وPageIndex وGraphRAG وLightRAG، أو LightRAG Server عن بُعد أو مكتبة Tencent IMA، أو مخزن Obsidian مرتبط، مع تحليل مستندات قابل للتوصيل.
...
Chat هي أيضاً نقطة انطلاق للقدرات الأعمق: **Quiz** لتوليد الأسئلة، و**Visualize** للمخططات / الرسوم البيانية / الرسوم المتحركة، و**Mastery Path** لتدفقات خطط التعلم، و**Immersive Reading** — مستند مفتوح بجانب المحادثة، حيث يُستشهَد بكل ادعاء بالصفحة التي جاء منها. أما **Research** للتقارير المستشهَد بها و**Solve** للتفكير المعمق فتحت *المزيد من القدرات*.
