...
[v1.5.12](past_releases/ver1-5-12.md) was about where an answer's material comes from. This one is mostly about Book — the surface that turns that material into something you *read* rather than something you chat with. A book could be generated but not really used: the page froze while it was being written, the progress it claimed to track was never written down, and what you got could not leave the app. That gap is the bulk of this release. The home screen also stops asking you to start from a blank composer. Drop-in — no migrations, nothing to re-index.
